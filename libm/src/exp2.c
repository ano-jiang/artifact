...
p0: starting input is -0x1.fffffep-7
p0: violated_input is 0x1.853a6ep-9, lb is 0x1.0087090000001p+0, ub is 0x1.008709fffffffp+0
Polynomial: y=0x1.fffffffffffffp-1 x^(0) + 0x1.62e42fefa3806p-1 x^(1) + 0x1.ebfbdff81263ap-3 x^(2) +
        0x1.c6b08b875921bp-5 x^(3)+ 0x1.3b2b5ff31806dp-7 x^(4) + 0x1.62bcac112f1e1p-10 x^(5)
#endif
    if (R == 0x1.853a6ep-9) {
