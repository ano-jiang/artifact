...
double prlibm_exp10(float x) {
    ...
    double y;
#if 0
    p0: number of violated intervals: 3, total iterations=163
p0: VIOLATING INPUTS BELOW THRESHOLD:
p0: starting input is -0x1.344134ad1cc2p-8
p0: violated_input is -0x1.0c34ef4921p-9, lb is 0x1.fd97e23938223p-1, ub is 0x1.fd97e3ccab9d1p-1
p0: violated_input is -0x1.82c1c01d78p-10, lb is 0x1.fe437ac045045p-1, ub is 0x1.fe437c3643b99p-1
p0: violated_input is 0x1.d924c938a8p-9, lb is 0x1.0222fe9de751bp+0, ub is 0x1.0222ff37c7972p+0
Polynomial: y=0x1p+0 x^(0) + 0x1.26bb1bbb556e2p+1 x^(1) + 0x1.53524c73a976cp+1 x^(2) + 0x1.047058593e235p+1 x^(3) +
        0x1.2bd7b721e1f58p+0 x^(4) + 0x1.172e9c2a696b7p-1 x^(5)
#endif
    if (R == -0x1.0c34ef4921p-9) {
        ...
        double coeffs[] = {
                0x1p+0,
                0x1.26bb1bbb556e2p+1,
                0x1.53524c73a976cp+1,
                0x1.047058593e235p+1,
                0x1.2bd7b721e1f58p+0,
                0x1.172e9c2a696b7p-1
        };
